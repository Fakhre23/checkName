<x-app-layout>
    <div class="flex h-screen">
        ...
        <div class="w-64 bg-gray-800 text-white p-6">
            ...
            <ul class="space-y-4">
                <li>
                    <a href="#" id="showSavedNames" class="block bg-gray-700 hover:bg-gray-600 rounded p-2">Saved
                        Names</a>
                </li>
                <li>
                    <a href="#" id="showReservedWords"
                        class="block bg-gray-700 hover:bg-gray-600 rounded p-2">Reserved Words</a>
                </li>
            </ul>
            <h2 class="text-2xl font-bold mb-8">Features</h2>
            <ul class="space-y-4">
                <li>
                    <a href="{{ route('searchName') }}" id="NameCheker"
